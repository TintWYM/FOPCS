...
namespace Day2
{
    class Program2
    {
        static void Main()
        {
            ...
            Console.WriteLine("remainder = {0}", x % y); //2 because both are integer

            double xx = 20.1;
            double yy = 3.1;

            Console.WriteLine("20/3 = {0}", xx / yy); //6.6 because it's NOT integer division
            Console.WriteLine("remainder = {0}", xx % yy); //1.5 because both are not integer
            Console.WriteLine("remainder = {0}", 5.0 % 2.2); //0.6 because both are not integer
